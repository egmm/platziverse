...
test.beforeEach(async () => {
  ...
  AgentStub.create.withArgs(newAgent).returns(Promise.resolve({ toJSON: () => newAgent }))
...
test.serial('Setup', t => {
  ...
  t.true(AgentStub.hasMany.calledWith(MetricStub), 'AgentMode.hasMany argument should be the MetricModel')
  t.true(MetricStub.belongsTo.called, 'MetricsModel.belongsTo was executed')
  t.true(MetricStub.belongsTo.calledWith(AgentStub), 'MetricsMode.belongsTo argument should be the AgentModel')
})
...
test.serial('Agent#createOrUpdate - new', async t => {
  ...
  t.true(AgentStub.findOne.called, 'findOne should be called on model')
  t.true(AgentStub.findOne.calledOnce, 'findOne should be called on model')
  t.true(AgentStub.create.called, 'create should be called on model')
  t.true(AgentStub.create.calledWith(newAgent), 'create should be called with agent object')
